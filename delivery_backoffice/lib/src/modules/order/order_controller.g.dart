...
mixin _$OrderController on OrderControllerBase, Store {
  ...
  late final _$chageStatusAsyncAction =
      AsyncAction('OrderControllerBase.chageStatus', context: context);

  @override
  Future<void> chageStatus(OrderStatus status) {
    return _$chageStatusAsyncAction.run(() => super.chageStatus(status));
  }
